...
type ActiveMeasurement struct {
	...
	Id             string `protobuf:"bytes,1,opt,name=id,proto3" json:"id,omitempty"`
	AverageSeconds int32  `protobuf:"varint,2,opt,name=average_seconds,json=averageSeconds,proto3" json:"average_seconds,omitempty"`
	TotalSeconds   int32  `protobuf:"varint,3,opt,name=total_seconds,json=totalSeconds,proto3" json:"total_seconds,omitempty"`
}
...
func (x *ActiveMeasurement) GetAverageSeconds() int32 {
	if x != nil {
...
func (x *ActiveMeasurement) GetTotalSeconds() int32 {
	if x != nil {
...
var file_block_user_proto_rawDesc = []byte{
	...
	,
	...
	0x74, 0x22, 0xa5, 0x03, 0x0a, 0x0c, 0x55, 0x73, 0x65, 0x72, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e,
	...
	0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x2a, 0x52, 0x0a, 0x09, 0x54, 0x6f, 0x6b,
	...
	0x06, 0x32, 0xe1, 0x0c, 0x0a, 0x0b, 0x55, 0x73, 0x65, 0x72, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63,
	...
	0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x17, 0x2e, 0x42, 0x6c, 0x6f, 0x63, 0x6b, 0x55, 0x73,
	0x65, 0x72, 0x2e, 0x55, 0x73, 0x65, 0x72, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22,
	0x00, 0x12, 0x4d, 0x0a, 0x18, 0x47, 0x65, 0x74, 0x55, 0x73, 0x65, 0x72, 0x41, 0x63, 0x74, 0x69,
	...
	0x12, 0x4e, 0x0a, 0x19, 0x47, 0x65, 0x74, 0x54, 0x6f, 0x74, 0x61, 0x6c, 0x41, 0x63, 0x74, 0x69,
	0x76, 0x65, 0x4d, 0x65, 0x61, 0x73, 0x75, 0x72, 0x65, 0x6d, 0x65, 0x6e, 0x74, 0x12, 0x16, 0x2e,
	0x42, 0x6c, 0x6f, 0x63, 0x6b, 0x55, 0x73, 0x65, 0x72, 0x2e, 0x55, 0x73, 0x65, 0x72, 0x52, 0x65,
	0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x17, 0x2e, 0x42, 0x6c, 0x6f, 0x63, 0x6b, 0x55, 0x73, 0x65,
	0x72, 0x2e, 0x55, 0x73, 0x65, 0x72, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00,
...
var file_block_user_proto_depIdxs = []int32{
	...
	4,  // 10: BlockUser.UserRequest.user:type_name -> BlockUser.User
	4,  // 11: BlockUser.UserRequest.update:type_name -> BlockUser.User
	5,  // 12: BlockUser.UserRequest.filter:type_name -> BlockUser.UserFilter
	4,  // 13: BlockUser.UserRequest.user_batch:type_name -> BlockUser.User
	6,  // 14: BlockUser.UserRequest.token:type_name -> BlockUser.Token
	7,  // 15: BlockUser.UserRequest.active_measurement:type_name -> BlockUser.ActiveMeasurement
	4,  // 16: BlockUser.UserResponse.user:type_name -> BlockUser.User
	4,  // 17: BlockUser.UserResponse.users:type_name -> BlockUser.User
	6,  // 18: BlockUser.UserResponse.token:type_name -> BlockUser.Token
	6,  // 19: BlockUser.UserResponse.tokens:type_name -> BlockUser.Token
	10, // 20: BlockUser.UserResponse.public_keys:type_name -> BlockUser.UserResponse.PublicKeysEntry
	7,  // 21: BlockUser.UserResponse.active_measurement:type_name -> BlockUser.ActiveMeasurement
	8,  // 22: BlockUser.UserService.Heartbeat:input_type -> BlockUser.UserRequest
	8,  // 23: BlockUser.UserService.Create:input_type -> BlockUser.UserRequest
	8,  // 24: BlockUser.UserService.UpdatePassword:input_type -> BlockUser.UserRequest
	8,  // 25: BlockUser.UserService.UpdateMetadata:input_type -> BlockUser.UserRequest
	8,  // 26: BlockUser.UserService.UpdateImage:input_type -> BlockUser.UserRequest
	8,  // 27: BlockUser.UserService.UpdateEmail:input_type -> BlockUser.UserRequest
	8,  // 28: BlockUser.UserService.UpdateOptionalId:input_type -> BlockUser.UserRequest
	8,  // 29: BlockUser.UserService.UpdateSecurity:input_type -> BlockUser.UserRequest
	8,  // 30: BlockUser.UserService.Get:input_type -> BlockUser.UserRequest
	8,  // 31: BlockUser.UserService.GetAll:input_type -> BlockUser.UserRequest
	8,  // 32: BlockUser.UserService.ValidateCredentials:input_type -> BlockUser.UserRequest
	8,  // 33: BlockUser.UserService.Login:input_type -> BlockUser.UserRequest
	8,  // 34: BlockUser.UserService.ValidateToken:input_type -> BlockUser.UserRequest
	8,  // 35: BlockUser.UserService.BlockToken:input_type -> BlockUser.UserRequest
	8,  // 36: BlockUser.UserService.BlockTokenById:input_type -> BlockUser.UserRequest
	8,  // 37: BlockUser.UserService.RefreshToken:input_type -> BlockUser.UserRequest
	8,  // 38: BlockUser.UserService.GetTokens:input_type -> BlockUser.UserRequest
	8,  // 39: BlockUser.UserService.PublicKeys:input_type -> BlockUser.UserRequest
	8,  // 40: BlockUser.UserService.RecordActiveMeasurement:input_type -> BlockUser.UserRequest
	8,  // 41: BlockUser.UserService.GetUserActiveMeasurement:input_type -> BlockUser.UserRequest
	8,  // 42: BlockUser.UserService.GetTotalActiveMeasurement:input_type -> BlockUser.UserRequest
	8,  // 43: BlockUser.UserService.Delete:input_type -> BlockUser.UserRequest
	8,  // 44: BlockUser.UserService.DeleteBatch:input_type -> BlockUser.UserRequest
	8,  // 45: BlockUser.UserService.DeleteNamespace:input_type -> BlockUser.UserRequest
	9,  // 46: BlockUser.UserService.Heartbeat:output_type -> BlockUser.UserResponse
	9,  // 47: BlockUser.UserService.Create:output_type -> BlockUser.UserResponse
	9,  // 48: BlockUser.UserService.UpdatePassword:output_type -> BlockUser.UserResponse
	9,  // 49: BlockUser.UserService.UpdateMetadata:output_type -> BlockUser.UserResponse
	9,  // 50: BlockUser.UserService.UpdateImage:output_type -> BlockUser.UserResponse
	9,  // 51: BlockUser.UserService.UpdateEmail:output_type -> BlockUser.UserResponse
	9,  // 52: BlockUser.UserService.UpdateOptionalId:output_type -> BlockUser.UserResponse
	9,  // 53: BlockUser.UserService.UpdateSecurity:output_type -> BlockUser.UserResponse
	9,  // 54: BlockUser.UserService.Get:output_type -> BlockUser.UserResponse
	9,  // 55: BlockUser.UserService.GetAll:output_type -> BlockUser.UserResponse
	9,  // 56: BlockUser.UserService.ValidateCredentials:output_type -> BlockUser.UserResponse
	9,  // 57: BlockUser.UserService.Login:output_type -> BlockUser.UserResponse
	9,  // 58: BlockUser.UserService.ValidateToken:output_type -> BlockUser.UserResponse
	9,  // 59: BlockUser.UserService.BlockToken:output_type -> BlockUser.UserResponse
	9,  // 60: BlockUser.UserService.BlockTokenById:output_type -> BlockUser.UserResponse
	9,  // 61: BlockUser.UserService.RefreshToken:output_type -> BlockUser.UserResponse
	9,  // 62: BlockUser.UserService.GetTokens:output_type -> BlockUser.UserResponse
	9,  // 63: BlockUser.UserService.PublicKeys:output_type -> BlockUser.UserResponse
	9,  // 64: BlockUser.UserService.RecordActiveMeasurement:output_type -> BlockUser.UserResponse
	9,  // 65: BlockUser.UserService.GetUserActiveMeasurement:output_type -> BlockUser.UserResponse
	9,  // 66: BlockUser.UserService.GetTotalActiveMeasurement:output_type -> BlockUser.UserResponse
	9,  // 67: BlockUser.UserService.Delete:output_type -> BlockUser.UserResponse
	9,  // 68: BlockUser.UserService.DeleteBatch:output_type -> BlockUser.UserResponse
	9,  // 69: BlockUser.UserService.DeleteNamespace:output_type -> BlockUser.UserResponse
