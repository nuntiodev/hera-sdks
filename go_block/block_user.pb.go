...
type UserStream_OperationType int32

const (
	UserStream_CREATE UserStream_OperationType = 0
	UserStream_UPDATE UserStream_OperationType = 1
	UserStream_DELETE UserStream_OperationType = 2
)

// Enum value maps for UserStream_OperationType.
var (
	UserStream_OperationType_name = map[int32]string{
		0: "CREATE",
		1: "UPDATE",
		2: "DELETE",
	}
	UserStream_OperationType_value = map[string]int32{
		"CREATE": 0,
		"UPDATE": 1,
		"DELETE": 2,
	}
...
func (x UserStream_OperationType) Enum() *UserStream_OperationType {
	p := new(UserStream_OperationType)
	*p = x
	return p
}

func (x UserStream_OperationType) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (UserStream_OperationType) Descriptor() protoreflect.EnumDescriptor {
	return file_block_user_proto_enumTypes[3].Descriptor()
}

func (UserStream_OperationType) Type() protoreflect.EnumType {
	return &file_block_user_proto_enumTypes[3]
}

func (x UserStream_OperationType) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use UserStream_OperationType.Descriptor instead.
func (UserStream_OperationType) EnumDescriptor() ([]byte, []int) {
...
type UserStream struct {
	...
	User          *User                    `protobuf:"bytes,1,opt,name=user,proto3" json:"user,omitempty"`
	OperationType UserStream_OperationType `protobuf:"varint,2,opt,name=operationType,proto3,enum=BlockUser.UserStream_OperationType" json:"operationType,omitempty"`
}
...
func (x *UserStream) GetOperationType() UserStream_OperationType {
	if x != nil {
		return x.OperationType
	}
	return UserStream_CREATE
}
...
var file_block_user_proto_rawDesc = []byte{
	...
	0x12, 0x07, 0x0a, 0x03, 0x44, 0x45, 0x43, 0x10, 0x01, 0x22, 0xa2, 0x02, 0x0a, 0x0b, 0x55, 0x73,
	...
	0x73, 0x65, 0x72, 0x52, 0x09, 0x75, 0x73, 0x65, 0x72, 0x42, 0x61, 0x74, 0x63, 0x68, 0x22, 0x7d,
	...
	0x52, 0x0b, 0x75, 0x73, 0x65, 0x72, 0x73, 0x41, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x22, 0xb1, 0x01,
	0x0a, 0x0a, 0x55, 0x73, 0x65, 0x72, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x12, 0x23, 0x0a, 0x04,
	...
	0x72, 0x12, 0x49, 0x0a, 0x0d, 0x6f, 0x70, 0x65, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x54, 0x79,
	0x70, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x23, 0x2e, 0x42, 0x6c, 0x6f, 0x63, 0x6b,
	0x55, 0x73, 0x65, 0x72, 0x2e, 0x55, 0x73, 0x65, 0x72, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x2e,
	0x4f, 0x70, 0x65, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x54, 0x79, 0x70, 0x65, 0x52, 0x0d, 0x6f,
	0x70, 0x65, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x54, 0x79, 0x70, 0x65, 0x22, 0x33, 0x0a, 0x0d,
	...
	0x02, 0x2a, 0x40, 0x0a, 0x0c, 0x4d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x54, 0x79, 0x70,
	0x65, 0x12, 0x16, 0x0a, 0x12, 0x4d, 0x45, 0x54, 0x41, 0x44, 0x41, 0x54, 0x41, 0x5f, 0x54, 0x59,
	0x50, 0x45, 0x5f, 0x4a, 0x53, 0x4f, 0x4e, 0x10, 0x00, 0x12, 0x18, 0x0a, 0x14, 0x4d, 0x45, 0x54,
	0x41, 0x44, 0x41, 0x54, 0x41, 0x5f, 0x54, 0x59, 0x50, 0x45, 0x5f, 0x53, 0x54, 0x52, 0x49, 0x4e,
	0x47, 0x10, 0x01, 0x32, 0xea, 0x07, 0x0a, 0x0b, 0x55, 0x73, 0x65, 0x72, 0x53, 0x65, 0x72, 0x76,
	...
	0x00, 0x12, 0x3e, 0x0a, 0x09, 0x47, 0x65, 0x74, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x12, 0x16,
	0x2e, 0x42, 0x6c, 0x6f, 0x63, 0x6b, 0x55, 0x73, 0x65, 0x72, 0x2e, 0x55, 0x73, 0x65, 0x72, 0x52,
	0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x15, 0x2e, 0x42, 0x6c, 0x6f, 0x63, 0x6b, 0x55, 0x73,
	0x65, 0x72, 0x2e, 0x55, 0x73, 0x65, 0x72, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x22, 0x00, 0x30,
	0x01, 0x12, 0x48, 0x0a, 0x13, 0x56, 0x61, 0x6c, 0x69, 0x64, 0x61, 0x74, 0x65, 0x43, 0x72, 0x65,
...
var file_block_user_proto_goTypes = []interface{}{
	...
	(UserStream_OperationType)(0), // 3: BlockUser.UserStream.OperationType
...
var file_block_user_proto_depIdxs = []int32{
	...
	4,  // 8: BlockUser.UserResponse.user:type_name -> BlockUser.User
	4,  // 9: BlockUser.UserResponse.users:type_name -> BlockUser.User
	4,  // 10: BlockUser.UserStream.user:type_name -> BlockUser.User
	3,  // 11: BlockUser.UserStream.operationType:type_name -> BlockUser.UserStream.OperationType
	6,  // 12: BlockUser.UserService.Heartbeat:input_type -> BlockUser.UserRequest
	6,  // 13: BlockUser.UserService.Create:input_type -> BlockUser.UserRequest
	6,  // 14: BlockUser.UserService.UpdatePassword:input_type -> BlockUser.UserRequest
	6,  // 15: BlockUser.UserService.UpdateMetadata:input_type -> BlockUser.UserRequest
	6,  // 16: BlockUser.UserService.UpdateImage:input_type -> BlockUser.UserRequest
	6,  // 17: BlockUser.UserService.UpdateEmail:input_type -> BlockUser.UserRequest
	6,  // 18: BlockUser.UserService.UpdateOptionalId:input_type -> BlockUser.UserRequest
	6,  // 19: BlockUser.UserService.UpdateSecurity:input_type -> BlockUser.UserRequest
	6,  // 20: BlockUser.UserService.Get:input_type -> BlockUser.UserRequest
	6,  // 21: BlockUser.UserService.GetAll:input_type -> BlockUser.UserRequest
	6,  // 22: BlockUser.UserService.GetStream:input_type -> BlockUser.UserRequest
	6,  // 23: BlockUser.UserService.ValidateCredentials:input_type -> BlockUser.UserRequest
	6,  // 24: BlockUser.UserService.Delete:input_type -> BlockUser.UserRequest
	6,  // 25: BlockUser.UserService.DeleteBatch:input_type -> BlockUser.UserRequest
	6,  // 26: BlockUser.UserService.DeleteNamespace:input_type -> BlockUser.UserRequest
	7,  // 27: BlockUser.UserService.Heartbeat:output_type -> BlockUser.UserResponse
	7,  // 28: BlockUser.UserService.Create:output_type -> BlockUser.UserResponse
	7,  // 29: BlockUser.UserService.UpdatePassword:output_type -> BlockUser.UserResponse
	7,  // 30: BlockUser.UserService.UpdateMetadata:output_type -> BlockUser.UserResponse
	7,  // 31: BlockUser.UserService.UpdateImage:output_type -> BlockUser.UserResponse
	7,  // 32: BlockUser.UserService.UpdateEmail:output_type -> BlockUser.UserResponse
	7,  // 33: BlockUser.UserService.UpdateOptionalId:output_type -> BlockUser.UserResponse
	7,  // 34: BlockUser.UserService.UpdateSecurity:output_type -> BlockUser.UserResponse
	7,  // 35: BlockUser.UserService.Get:output_type -> BlockUser.UserResponse
	7,  // 36: BlockUser.UserService.GetAll:output_type -> BlockUser.UserResponse
	8,  // 37: BlockUser.UserService.GetStream:output_type -> BlockUser.UserStream
	7,  // 38: BlockUser.UserService.ValidateCredentials:output_type -> BlockUser.UserResponse
	7,  // 39: BlockUser.UserService.Delete:output_type -> BlockUser.UserResponse
	7,  // 40: BlockUser.UserService.DeleteBatch:output_type -> BlockUser.UserResponse
	7,  // 41: BlockUser.UserService.DeleteNamespace:output_type -> BlockUser.UserResponse
