...
type ActiveHistoryData struct {
	...
	Dau     map[string]bool            `protobuf:"bytes,4,rep,name=dau,proto3" json:"dau,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3"`
}
...
func (x *ActiveHistoryData) GetDau() map[string]bool {
	if x != nil {
		return x.Dau
	}
	return nil
