...
var file_block_user_proto_rawDesc = []byte{
	...
	0x04, 0x74, 0x79, 0x70, 0x65, 0x22, 0x91, 0x01, 0x0a, 0x11, 0x41, 0x63, 0x74, 0x69, 0x76, 0x65,
	...
	0x63, 0x72, 0x65, 0x61, 0x74, 0x65, 0x64, 0x41, 0x74, 0x22, 0xc2, 0x04, 0x0a, 0x0b, 0x55, 0x73,
	...
	0x05, 0x12, 0x0b, 0x0a, 0x07, 0x57, 0x49, 0x4e, 0x44, 0x4f, 0x57, 0x53, 0x10, 0x06, 0x32, 0xef,
	...
	0x0a, 0x1f, 0x47, 0x65, 0x74, 0x55, 0x73, 0x65, 0x72, 0x41, 0x76, 0x65, 0x72, 0x61, 0x67, 0x65,
	...
	0x73, 0x65, 0x22, 0x00, 0x12, 0x55, 0x0a, 0x20, 0x47, 0x65, 0x74, 0x54, 0x6f, 0x74, 0x61, 0x6c,
	0x41, 0x76, 0x65, 0x72, 0x61, 0x67, 0x65, 0x41, 0x63, 0x74, 0x69, 0x76, 0x65, 0x4d, 0x65, 0x61,
...
var file_block_user_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var file_block_user_proto_goTypes = []interface{}{
	...
	(*UserRequest)(nil),           // 8: BlockUser.UserRequest
	(*UserResponse)(nil),          // 9: BlockUser.UserResponse
	nil,                           // 10: BlockUser.UserResponse.PublicKeysEntry
	(*timestamppb.Timestamp)(nil), // 11: google.protobuf.Timestamp
}
var file_block_user_proto_depIdxs = []int32{
	11, // 0: BlockUser.User.created_at:type_name -> google.protobuf.Timestamp
	11, // 1: BlockUser.User.updated_at:type_name -> google.protobuf.Timestamp
	11, // 2: BlockUser.User.encrypted_at:type_name -> google.protobuf.Timestamp
	...
	11, // 5: BlockUser.Token.blocked_at:type_name -> google.protobuf.Timestamp
	11, // 6: BlockUser.Token.created_at:type_name -> google.protobuf.Timestamp
	11, // 7: BlockUser.Token.used_at:type_name -> google.protobuf.Timestamp
	11, // 8: BlockUser.Token.expires_at:type_name -> google.protobuf.Timestamp
	0,  // 9: BlockUser.Token.type:type_name -> BlockUser.TokenType
	11, // 10: BlockUser.ActiveMeasurement.created_at:type_name -> google.protobuf.Timestamp
	4,  // 11: BlockUser.UserRequest.user:type_name -> BlockUser.User
	4,  // 12: BlockUser.UserRequest.update:type_name -> BlockUser.User
	5,  // 13: BlockUser.UserRequest.filter:type_name -> BlockUser.UserFilter
	4,  // 14: BlockUser.UserRequest.user_batch:type_name -> BlockUser.User
	6,  // 15: BlockUser.UserRequest.token:type_name -> BlockUser.Token
	7,  // 16: BlockUser.UserRequest.active_measurement:type_name -> BlockUser.ActiveMeasurement
	4,  // 17: BlockUser.UserResponse.user:type_name -> BlockUser.User
	4,  // 18: BlockUser.UserResponse.users:type_name -> BlockUser.User
	6,  // 19: BlockUser.UserResponse.token:type_name -> BlockUser.Token
	6,  // 20: BlockUser.UserResponse.tokens:type_name -> BlockUser.Token
	10, // 21: BlockUser.UserResponse.public_keys:type_name -> BlockUser.UserResponse.PublicKeysEntry
	7,  // 22: BlockUser.UserResponse.active_measurement:type_name -> BlockUser.ActiveMeasurement
	8,  // 23: BlockUser.UserService.Heartbeat:input_type -> BlockUser.UserRequest
	8,  // 24: BlockUser.UserService.Create:input_type -> BlockUser.UserRequest
	8,  // 25: BlockUser.UserService.UpdatePassword:input_type -> BlockUser.UserRequest
	8,  // 26: BlockUser.UserService.UpdateMetadata:input_type -> BlockUser.UserRequest
	8,  // 27: BlockUser.UserService.UpdateImage:input_type -> BlockUser.UserRequest
	8,  // 28: BlockUser.UserService.UpdateEmail:input_type -> BlockUser.UserRequest
	8,  // 29: BlockUser.UserService.UpdateOptionalId:input_type -> BlockUser.UserRequest
	8,  // 30: BlockUser.UserService.UpdateSecurity:input_type -> BlockUser.UserRequest
	8,  // 31: BlockUser.UserService.Get:input_type -> BlockUser.UserRequest
	8,  // 32: BlockUser.UserService.GetAll:input_type -> BlockUser.UserRequest
	8,  // 33: BlockUser.UserService.ValidateCredentials:input_type -> BlockUser.UserRequest
	8,  // 34: BlockUser.UserService.Login:input_type -> BlockUser.UserRequest
	8,  // 35: BlockUser.UserService.ValidateToken:input_type -> BlockUser.UserRequest
	8,  // 36: BlockUser.UserService.BlockToken:input_type -> BlockUser.UserRequest
	8,  // 37: BlockUser.UserService.BlockTokenById:input_type -> BlockUser.UserRequest
	8,  // 38: BlockUser.UserService.RefreshToken:input_type -> BlockUser.UserRequest
	8,  // 39: BlockUser.UserService.GetTokens:input_type -> BlockUser.UserRequest
	8,  // 40: BlockUser.UserService.PublicKeys:input_type -> BlockUser.UserRequest
	8,  // 41: BlockUser.UserService.RecordActiveMeasurement:input_type -> BlockUser.UserRequest
	8,  // 42: BlockUser.UserService.GetUserAverageActiveMeasurement:input_type -> BlockUser.UserRequest
	8,  // 43: BlockUser.UserService.GetTotalAverageActiveMeasurement:input_type -> BlockUser.UserRequest
	8,  // 44: BlockUser.UserService.Delete:input_type -> BlockUser.UserRequest
	8,  // 45: BlockUser.UserService.DeleteBatch:input_type -> BlockUser.UserRequest
	8,  // 46: BlockUser.UserService.DeleteNamespace:input_type -> BlockUser.UserRequest
	9,  // 47: BlockUser.UserService.Heartbeat:output_type -> BlockUser.UserResponse
	9,  // 48: BlockUser.UserService.Create:output_type -> BlockUser.UserResponse
	9,  // 49: BlockUser.UserService.UpdatePassword:output_type -> BlockUser.UserResponse
	9,  // 50: BlockUser.UserService.UpdateMetadata:output_type -> BlockUser.UserResponse
	9,  // 51: BlockUser.UserService.UpdateImage:output_type -> BlockUser.UserResponse
	9,  // 52: BlockUser.UserService.UpdateEmail:output_type -> BlockUser.UserResponse
	9,  // 53: BlockUser.UserService.UpdateOptionalId:output_type -> BlockUser.UserResponse
	9,  // 54: BlockUser.UserService.UpdateSecurity:output_type -> BlockUser.UserResponse
	9,  // 55: BlockUser.UserService.Get:output_type -> BlockUser.UserResponse
	9,  // 56: BlockUser.UserService.GetAll:output_type -> BlockUser.UserResponse
	9,  // 57: BlockUser.UserService.ValidateCredentials:output_type -> BlockUser.UserResponse
	9,  // 58: BlockUser.UserService.Login:output_type -> BlockUser.UserResponse
	9,  // 59: BlockUser.UserService.ValidateToken:output_type -> BlockUser.UserResponse
	9,  // 60: BlockUser.UserService.BlockToken:output_type -> BlockUser.UserResponse
	9,  // 61: BlockUser.UserService.BlockTokenById:output_type -> BlockUser.UserResponse
	9,  // 62: BlockUser.UserService.RefreshToken:output_type -> BlockUser.UserResponse
	9,  // 63: BlockUser.UserService.GetTokens:output_type -> BlockUser.UserResponse
	9,  // 64: BlockUser.UserService.PublicKeys:output_type -> BlockUser.UserResponse
	9,  // 65: BlockUser.UserService.RecordActiveMeasurement:output_type -> BlockUser.UserResponse
	9,  // 66: BlockUser.UserService.GetUserAverageActiveMeasurement:output_type -> BlockUser.UserResponse
	9,  // 67: BlockUser.UserService.GetTotalAverageActiveMeasurement:output_type -> BlockUser.UserResponse
	9,  // 68: BlockUser.UserService.Delete:output_type -> BlockUser.UserResponse
	9,  // 69: BlockUser.UserService.DeleteBatch:output_type -> BlockUser.UserResponse
	9,  // 70: BlockUser.UserService.DeleteNamespace:output_type -> BlockUser.UserResponse
