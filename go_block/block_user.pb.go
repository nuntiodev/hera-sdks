...
type ActiveHistoryData struct {
	...
	Device  map[int32]int32            `protobuf:"bytes,5,rep,name=device,proto3" json:"device,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3"`
}
...
func (x *ActiveHistoryData) GetDevice() map[int32]int32 {
	if x != nil {
		return x.Device
	}
	return nil
