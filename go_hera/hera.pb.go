...
type Scrypt struct {
	...
	SignerKey     []byte `protobuf:"bytes,1,opt,name=signer_key,json=signerKey,proto3" json:"signer_key,omitempty"`
...
func (x *Scrypt) GetSignerKey() []byte {
	if x != nil {
		return x.SignerKey
	}
	return nil
...
var file_hera_proto_rawDesc = []byte{
	...
	0x73, 0x69, 0x67, 0x6e, 0x65, 0x72, 0x5f, 0x6b, 0x65, 0x79, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0c,
	...
	0x01, 0x28, 0x0c, 0x52, 0x0d, 0x73, 0x61, 0x6c, 0x74, 0x53, 0x65, 0x70, 0x61, 0x72, 0x61, 0x74,
