...
const User$json = const {
  ...
  '2': const [
    ...
    const {'1': 'email_verification_code', '3': 13, '4': 1, '5': 11, '6': '.Hera.Hash', '10': 'emailVerificationCode'},
    ...
    const {'1': 'reset_password_code', '3': 16, '4': 1, '5': 11, '6': '.Hera.Hash', '10': 'resetPasswordCode'},
    ...
    const {'1': 'phone_verification_code', '3': 25, '4': 1, '5': 11, '6': '.Hera.Hash', '10': 'phoneVerificationCode'},
    ...
    const {'1': 'postal_code', '3': 35, '4': 1, '5': 9, '9': 12, '10': 'postalCode', '17': true},
  ],
  '8': const [
    const {'1': '_username'},
    const {'1': '_email'},
...
final $typed_data.Uint8List userDescriptor = $convert.base64Decode('');
