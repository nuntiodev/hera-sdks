...
goog.exportSymbol('proto.BlockUser.UserStream.OperationType', null, global);
/**
...
proto.BlockUser.UserStream.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 1:
      ...
      break;
    case 2:
      var value = /** @type {!proto.BlockUser.UserStream.OperationType} */ (reader.readEnum());
 ...
 * @enum {number}
 */
proto.BlockUser.UserStream.OperationType = {
  CREATE: 0,
  UPDATE: 1,
  DELETE: 2
};
 ...
 * @return {!proto.BlockUser.UserStream.OperationType}
 */
proto.BlockUser.UserStream.prototype.getOperationtype = function() {
  return /** @type {!proto.BlockUser.UserStream.OperationType} */ (jspb.Message.getFieldWithDefault(this, 2, 0));
};


/**
 * @param {!proto.BlockUser.UserStream.OperationType} value
 * @return {!proto.BlockUser.UserStream} returns this
 */
proto.BlockUser.UserStream.prototype.setOperationtype = function(value) {
