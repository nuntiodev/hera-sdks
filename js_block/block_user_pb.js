...
goog.exportSymbol('proto.BlockUser.UserStream', null, global);
/**
 ...
 * @constructor
 */
proto.BlockUser.UserStream = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.BlockUser.UserStream.repeatedFields_, null);
};
goog.inherits(proto.BlockUser.UserStream, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.BlockUser.UserStream.displayName = 'proto.BlockUser.UserStream';
}
 ...
 * @const
 */
proto.BlockUser.UserRequest.repeatedFields_ = [7,8];
...
proto.BlockUser.UserRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 7:
      ...
      break;
    case 8:
      var values = /** @type {!Array<!proto.BlockUser.StreamType>} */ (reader.isDelimited() ? reader.readPackedEnum() : [reader.readEnum()]);
 ...
 * @return {!Array<!proto.BlockUser.StreamType>}
 */
proto.BlockUser.UserRequest.prototype.getStreamTypeList = function() {
  return /** @type {!Array<!proto.BlockUser.StreamType>} */ (jspb.Message.getRepeatedField(this, 8));
};


/**
 * @param {!Array<!proto.BlockUser.StreamType>} value
 * @return {!proto.BlockUser.UserRequest} returns this
 */
proto.BlockUser.UserRequest.prototype.setStreamTypeList = function(value) {
  return jspb.Message.setField(this, 8, value || []);
};


/**
 * @param {!proto.BlockUser.StreamType} value
 * @param {number=} opt_index
 * @return {!proto.BlockUser.UserRequest} returns this
 */
proto.BlockUser.UserRequest.prototype.addStreamType = function(value, opt_index) {
 ...
 * @const
 */
proto.BlockUser.UserStream.repeatedFields_ = [2];
 ...
 * @return {!Object}
 */
proto.BlockUser.UserStream.prototype.toObject = function(opt_includeInstance) {
  return proto.BlockUser.UserStream.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.BlockUser.UserStream} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.BlockUser.UserStream.toObject = function(includeInstance, msg) {
  var f, obj = {
    user: (f = msg.getUser()) && proto.BlockUser.User.toObject(includeInstance, f),
    usersList: jspb.Message.toObjectList(msg.getUsersList(),
    proto.BlockUser.User.toObject, includeInstance),
    streamType: jspb.Message.getFieldWithDefault(msg, 3, 0)
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.BlockUser.UserStream}
 */
proto.BlockUser.UserStream.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.BlockUser.UserStream;
  return proto.BlockUser.UserStream.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.BlockUser.UserStream} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.BlockUser.UserStream}
 */
proto.BlockUser.UserStream.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
    ...
    case 2:
      ...
      break;
    case 3:
      var value = /** @type {!proto.BlockUser.StreamType} */ (reader.readEnum());
 ...
 * @return {!Uint8Array}
 */
proto.BlockUser.UserStream.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.BlockUser.UserStream.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.BlockUser.UserStream} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.BlockUser.UserStream.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getUser();
  if (f != null) {
    writer.writeMessage(
 ...
 * @return {?proto.BlockUser.User}
 */
proto.BlockUser.UserStream.prototype.getUser = function() {
  return /** @type{?proto.BlockUser.User} */ (
    jspb.Message.getWrapperField(this, proto.BlockUser.User, 1));
};
...
/**
 * @param {?proto.BlockUser.User|undefined} value
 * @return {!proto.BlockUser.UserStream} returns this
*/
proto.BlockUser.UserStream.prototype.setUser = function(value) {
  return jspb.Message.setWrapperField(this, 1, value);
};
 ...
 * @return {!proto.BlockUser.UserStream} returns this
 */
proto.BlockUser.UserStream.prototype.clearUser = function() {
  return this.setUser(undefined);
};
 ...
 * @return {boolean}
 */
proto.BlockUser.UserStream.prototype.hasUser = function() {
  return jspb.Message.getField(this, 1) != null;
};
 ...
 * @return {!Array<!proto.BlockUser.User>}
 */
proto.BlockUser.UserStream.prototype.getUsersList = function() {
  return /** @type{!Array<!proto.BlockUser.User>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.BlockUser.User, 2));
};
 ...
 * @return {!proto.BlockUser.UserStream} returns this
*/
proto.BlockUser.UserStream.prototype.setUsersList = function(value) {
  return jspb.Message.setRepeatedWrapperField(this, 2, value);
};
 ...
 * @return {!proto.BlockUser.User}
 */
proto.BlockUser.UserStream.prototype.addUsers = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 2, opt_value, proto.BlockUser.User, opt_index);
};
 ...
 * @return {!proto.BlockUser.UserStream} returns this
 */
proto.BlockUser.UserStream.prototype.clearUsersList = function() {
  return this.setUsersList([]);
};


/**
 * optional StreamType stream_type = 3;
 * @return {!proto.BlockUser.StreamType}
 */
proto.BlockUser.UserStream.prototype.getStreamType = function() {
  return /** @type {!proto.BlockUser.StreamType} */ (jspb.Message.getFieldWithDefault(this, 3, 0));
};
 ...
 * @return {!proto.BlockUser.UserStream} returns this
 */
proto.BlockUser.UserStream.prototype.setStreamType = function(value) {
  return jspb.Message.setProto3EnumField(this, 3, value);
};
