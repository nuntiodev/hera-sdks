...
goog.exportSymbol('proto.BlockUser.MonthDayMap', null, global);
 ...
 * @constructor
 */
proto.BlockUser.MonthDayMap = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.BlockUser.MonthDayMap, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.BlockUser.MonthDayMap.displayName = 'proto.BlockUser.MonthDayMap';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @return {!Object}
 */
proto.BlockUser.MonthDayMap.prototype.toObject = function(opt_includeInstance) {
  return proto.BlockUser.MonthDayMap.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.BlockUser.MonthDayMap} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.BlockUser.MonthDayMap}
 */
proto.BlockUser.MonthDayMap.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.BlockUser.MonthDayMap;
  return proto.BlockUser.MonthDayMap.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.BlockUser.MonthDayMap} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.BlockUser.MonthDayMap}
 */
proto.BlockUser.MonthDayMap.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.BlockUser.MonthDayMap.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.BlockUser.MonthDayMap.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.BlockUser.MonthDayMap} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.BlockUser.MonthDayMap.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getSecondsMap(true);
  if (f && f.getLength() > 0) {
...
/**
 * map<int32, int32> seconds = 1;
 * @param {boolean=} opt_noLazyCreate Do not create the map if
 * empty, instead returning `undefined`
 * @return {!jspb.Map<number,number>}
 */
proto.BlockUser.MonthDayMap.prototype.getSecondsMap = function(opt_noLazyCreate) {
...
proto.BlockUser.ActiveHistory.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    userId: jspb.Message.getFieldWithDefault(msg, 2, ""),
    dataMap: (f = msg.getDataMap()) ? f.toObject(includeInstance, proto.BlockUser.MonthDayMap.toObject) : []
  };
...
proto.BlockUser.ActiveHistory.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 3:
      ...
      reader.readMessage(value, function(message, reader) {
        jspb.Map.deserializeBinary(message, reader, jspb.BinaryReader.prototype.readInt32, jspb.BinaryReader.prototype.readMessage, proto.BlockUser.MonthDayMap.deserializeBinaryFromReader, 0, new proto.BlockUser.MonthDayMap());
         });
      break;
    default:
      reader.skipField();
...
proto.BlockUser.ActiveHistory.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f && f.getLength() > 0) {
    f.serializeBinary(3, writer, jspb.BinaryWriter.prototype.writeInt32, jspb.BinaryWriter.prototype.writeMessage, proto.BlockUser.MonthDayMap.serializeBinaryToWriter);
  }
};
...
/**
 * map<int32, MonthDayMap> data = 3;
 * @param {boolean=} opt_noLazyCreate Do not create the map if
 * empty, instead returning `undefined`
 * @return {!jspb.Map<number,!proto.BlockUser.MonthDayMap>}
 */
proto.BlockUser.ActiveHistory.prototype.getDataMap = function(opt_noLazyCreate) {
  return /** @type {!jspb.Map<number,!proto.BlockUser.MonthDayMap>} */ (
      jspb.Message.getMapField(this, 3, opt_noLazyCreate,
      proto.BlockUser.MonthDayMap));
};
