...
const LoginType$json = const {
  ...
  '2': const [
    ...
    const {'1': 'LOGIN_TYPE_EMAIL_VERIFICATION_CODE', '2': 3},
    const {'1': 'LOGIN_TYPE_PHONE_VERIFICATION_CODE', '2': 4},
  ],
};
...
const Config$json = const {
  ...
  '2': const [
    ...
    const {'1': 'validate_password', '3': 9, '4': 1, '5': 8, '10': 'validatePassword'},
    const {'1': 'nuntio_connect_id', '3': 10, '4': 1, '5': 9, '10': 'nuntioConnectId'},
...
final $typed_data.Uint8List configDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List emailDescriptor = $convert.base64Decode('');
...
const User$json = const {
  ...
  '2': const [
    ...
    const {'1': 'phone_number', '3': 24, '4': 1, '5': 9, '9': 6, '10': 'phoneNumber', '17': true},
    ...
    const {'1': 'preferred_language', '3': 29, '4': 1, '5': 14, '6': '.BlockUser.LanguageCode', '9': 7, '10': 'preferredLanguage', '17': true},
...
final $typed_data.Uint8List userDescriptor = $convert.base64Decode('');
...
const Token$json = const {
  ...
  '2': const [
    ...
    const {'1': 'logged_in_from', '3': 11, '4': 1, '5': 11, '6': '.BlockUser.Location', '10': 'loggedInFrom'},
    const {'1': 'type', '3': 12, '4': 1, '5': 14, '6': '.BlockUser.TokenType', '10': 'type'},
  ],
};

/// Descriptor for `Token`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List tokenDescriptor = $convert.base64Decode('');
...
const UserRequest$json = const {
  ...
  '2': const [
    ...
    const {'1': 'search', '3': 17, '4': 1, '5': 9, '10': 'search'},
  ],
};

/// Descriptor for `UserRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List userRequestDescriptor = $convert.base64Decode('');
