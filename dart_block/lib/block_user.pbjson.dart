...
const Text$json = const {
  ...
  '2': const [
    ...
    const {'1': 'available_languages', '3': 3, '4': 3, '5': 14, '6': '.BlockUser.LanguageCode', '10': 'availableLanguages'},
    const {'1': 'supported_languages', '3': 4, '4': 3, '5': 14, '6': '.BlockUser.LanguageCode', '10': 'supportedLanguages'},
    const {'1': 'general_text', '3': 5, '4': 1, '5': 11, '6': '.BlockUser.GeneralText', '10': 'generalText'},
    const {'1': 'welcome_text', '3': 6, '4': 1, '5': 11, '6': '.BlockUser.WelcomeText', '10': 'welcomeText'},
...
const Config$json = const {
  ...
  '2': const [
    ...
    const {'1': 'default_language', '3': 14, '4': 1, '5': 14, '6': '.BlockUser.LanguageCode', '10': 'defaultLanguage'},
    const {'1': 'internal_encryption_level', '3': 15, '4': 1, '5': 5, '10': 'internalEncryptionLevel'},
  ],
};

/// Descriptor for `Config`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List configDescriptor = $convert.base64Decode('');
...
const User$json = const {
  ...
  '2': const [
    ...
    const {'1': 'verification_email_sent_at', '3': 17, '4': 1, '5': 11, '6': '.google.protobuf.Timestamp', '10': 'verificationEmailSentAt'},
    const {'1': 'email_verification_code', '3': 18, '4': 1, '5': 9, '10': 'emailVerificationCode'},
    const {'1': 'verification_email_expires_at', '3': 19, '4': 1, '5': 11, '6': '.google.protobuf.Timestamp', '10': 'verificationEmailExpiresAt'},
    const {'1': 'verify_email_attempts', '3': 20, '4': 1, '5': 5, '10': 'verifyEmailAttempts'},
    const {'1': 'reset_password_code', '3': 21, '4': 1, '5': 9, '10': 'resetPasswordCode'},
    const {'1': 'reset_password_email_sent_at', '3': 22, '4': 1, '5': 11, '6': '.google.protobuf.Timestamp', '10': 'resetPasswordEmailSentAt'},
    const {'1': 'reset_password_email_expires_at', '3': 23, '4': 1, '5': 11, '6': '.google.protobuf.Timestamp', '10': 'resetPasswordEmailExpiresAt'},
    ...
    const {'1': 'verified_phone_numbers', '3': 31, '4': 3, '5': 9, '10': 'verifiedPhoneNumbers'},
    const {'1': 'preffered_language', '3': 32, '4': 1, '5': 14, '6': '.BlockUser.LanguageCode', '10': 'prefferedLanguage'},
  ],
};

/// Descriptor for `User`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List userDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List userResponseDescriptor = $convert.base64Decode('');
